...
def main(args=args):
    ...
    if args.contin:
        ...
        writer_log_dir = "{}/{}-M2-VAE_OPT_ab/runs/train_time:{}".format(args.base_path, args.dataset,
                                                                    args.train_time)
        ...
        optimizer = torch.optim.SGD(model.parameters(), lr=args.lr, momentum=args.beta1, weight_decay=args.wd)
        scheduler = MultiStepLR(optimizer, milestones=args.adjust_lr, gamma = 0.2)
        writer_log_dir = "{}/{}-M2-VAE_OPT/runs/train_time:{}".format(args.base_path, args.dataset,
                                                                    args.train_time)
    ...
    with open(writer_log_dir +'/commandline_args.txt', 'w') as f:
...
def save_checkpoint(state, filename='checkpoint.pth.tar', best_predict=False):
    ...
    :return:
    """
    filefolder = '{}/{}-M2-VAE_OPT_ab/parameter/train_time_{}'.format(args.base_path, args.dataset,
