...
def main(args=args):
    ...
    if args.contin:
        ...
        writer_log_dir = "{}/{}-SHOT-VAE_OPT/runs/train_time:{}".format(args.base_path, args.dataset,
                                                                    args.train_time)
...
def save_checkpoint(state, filename='checkpoint.pth.tar', best_predict=False):
    ...
    :return:
    """
    filefolder = '{}/{}-SHOT-VAE_OPT/parameter/train_time_{}'.format(args.base_path, args.dataset,
